...
Salud general y mental según consumo de alcohol (II)
...
ENPG_filtrado %>% 
  ...
  theme_minimal()
```
Los resultados descriptivos muestran diferencias consistentes en los indicadores de salud mental según el consumo de alcohol en los últimos 30 días. En general, las personas que reportan consumo de alcohol presentan medias ligeramente más altas en indicadores asociados a malestar emocional, como agobio y problemas de sueño, en comparación con quienes no han consumido alcohol. Por ejemplo, la media de agobio es mayor en el grupo que consumió alcohol (0,77) que en el grupo que no consumió (0,73), mientras que en el caso del sueño también se observa una media más elevada entre quienes consumieron alcohol (0,83 frente a 0,79). Estas diferencias, aunque de magnitud moderada, sugieren una posible asociación entre el consumo reciente de alcohol y una mayor presencia de dificultades en el bienestar psicológico.

Por el contrario, en variables como confianza personal, depresión, frustración y valía moral, las personas que no consumieron alcohol tienden a presentar valores promedio ligeramente más favorables que quienes sí lo hicieron. En particular, la valía moral y la confianza muestran medias más bajas en el grupo con consumo de alcohol, lo que podría reflejar una percepción menos positiva de sí mismos en este grupo. El gráfico de medias con intervalos de confianza al 95% refuerza estas diferencias descriptivas, mostrando patrones relativamente consistentes entre ambos grupos. No obstante, estas diferencias deben interpretarse con cautela, ya que corresponden a un análisis descriptivo y no implican causalidad, además de verse afectadas por la presencia de valores perdidos en algunas variables.
...
# 10Correlaciones Spearman + p-values + N
...
El modelo de regresión logística permitió identificar factores asociados al consumo de alcohol en los últimos 30 días, mostrando un ajuste adecuado y una capacidad de discriminación moderada (AUC = 0,72). En términos de desempeño predictivo, el modelo presenta una exactitud del 69,7%, con alta especificidad (88,9%) y sensibilidad moderada-baja (33,0%), lo que indica mayor precisión para identificar a quienes no consumen alcohol.

Los resultados evidencian que el género masculino incrementa significativamente la probabilidad de consumo, mientras que la edad y la pertenencia religiosa se asocian con una menor probabilidad. Asimismo, el consumo de otras sustancias presenta una relación fuerte y positiva con el consumo de alcohol, destacando marihuana, cocaína y cigarrillos, lo que sugiere la presencia de patrones de policonsumo.

En relación con variables psicosociales, mayores niveles de problemas de sueño, agobio y frustración aumentan la probabilidad de consumo, mientras que una mayor valía moral actúa como factor protector. Por otra parte, una mayor percepción de riesgo ocasional se asocia con una menor probabilidad de consumo. Finalmente, la situación laboral y algunas categorías de salud general y cargo ocupacional muestran asociaciones significativas, lo que sugiere diferencias en los patrones de consumo según condiciones sociales y laborales.
