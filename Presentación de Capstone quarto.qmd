...
ENPG_filtrado <- ENPG_2024 %>% 
  select(
    RESPONDENT_SERIAL, EDAD, SEXO, OH_1, OH_2, OH_4,
    DP_4, DP_5, DP_8, DP_12, DP_16, DP_2,
    MAR_1, MAR_4, PB_1, PB_4, COC_1, COC_4,
    TUS_1, TUS_4,
    ST_1, ST_2, ST_5,
    T_SG_1_B, T_SG_1_E, T_SG_1_F, T_SG_1_I, T_SG_1_J, T_SG_1_K,
    T_PR_1_2, T_PR_1_3,
    CO_1, CO_6
  ) %>% na.omit()
```
